...
enum instr_bit {
	...
	INSTR_BIT_API_COND_WAIT,
	INSTR_BIT_API_COND_SIGNAL,
	INSTR_BIT_API_COND_BROADCAST,
...
#define INSTR_FLAG_API_COND_WAIT		BIT(INSTR_BIT_API_COND_WAIT)
#define INSTR_FLAG_API_COND_SIGNAL		BIT(INSTR_BIT_API_COND_SIGNAL)
#define INSTR_FLAG_API_COND_BROADCAST	BIT(INSTR_BIT_API_COND_BROADCAST)
...
INSTR_0ARG(API_BARRIER_WAIT, instr_barrier_wait_enter, "VAb")
INSTR_0ARG(API_BARRIER_WAIT, instr_barrier_wait_exit, "VAB")
INSTR_0ARG(API_COND_WAIT, instr_cond_wait_enter, "VAo")
INSTR_0ARG(API_COND_WAIT, instr_cond_wait_exit, "VAO")
INSTR_0ARG(API_COND_SIGNAL, instr_cond_signal_enter, "VAg")
INSTR_0ARG(API_COND_SIGNAL, instr_cond_signal_exit, "VAG")
INSTR_0ARG(API_COND_BROADCAST, instr_cond_broadcast_enter, "VAk")
INSTR_0ARG(API_COND_BROADCAST, instr_cond_broadcast_exit, "VAK")
