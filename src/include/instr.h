...
#define INSTR_FLAG_BASIC			__BIT(0)
#define INSTR_FLAG_WORKER			__BIT(1)
#define INSTR_FLAG_SCHEDULER		__BIT(2)
#define INSTR_FLAG_SCHEDULER_SUBMIT	__BIT(3)
#define INSTR_FLAG_ALLOC			__BIT(4)
#define INSTR_FLAG_API_SUBMIT		__BIT(5)
#define INSTR_FLAG_API_PAUSE		__BIT(6)
#define INSTR_FLAG_API_YIELD		__BIT(7)
#define INSTR_FLAG_API_WAITFOR		__BIT(8)
#define INSTR_FLAG_API_SCHEDPOINT	__BIT(9)
#define INSTR_FLAG_TASK				__BIT(10)
#define INSTR_FLAG_KERNEL			__BIT(11)
...
#define INSTR_LEVEL_4 (INSTR_LEVEL_3 | INSTR_FLAG_ALLOC)
...
INSTR_0ARG(ALLOC, instr_salloc_enter, "VMa")
INSTR_0ARG(ALLOC, instr_salloc_exit, "VMA")
INSTR_0ARG(ALLOC, instr_sfree_enter, "VMf")
INSTR_0ARG(ALLOC, instr_sfree_exit, "VMF")
