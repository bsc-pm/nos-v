...
static const uint64_t control_flags_mask[] = {
	...
	[INSTR_BIT_API_COND_WAIT]       = INSTR_FLAG_API_COND_WAIT,
	[INSTR_BIT_API_COND_SIGNAL]     = INSTR_FLAG_API_COND_SIGNAL,
	[INSTR_BIT_API_COND_BROADCAST]  = INSTR_FLAG_API_COND_BROADCAST,
...
static const char *control_flags[] = {
	...
	[INSTR_BIT_API_COND_WAIT]       = "api_cond_wait",
	[INSTR_BIT_API_COND_SIGNAL]     = "api_cond_signal",
	[INSTR_BIT_API_COND_BROADCAST]  = "api_cond_broadcast",
